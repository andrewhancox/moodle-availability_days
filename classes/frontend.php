...
class frontend extends \core_availability\frontend {
    ...
    protected function get_javascript_strings() {
        return array('short_days', 'conditiontitle', 'applyrestrictionforuserafter', 'years', 'months', 'weeks', 'days', 'minutes', 'seconds', 'enableenrolledafter');
    }
    ...
    protected function get_javascript_init_params($course, \cm_info $cm = null,
        ...
        $html = '<span class="availability-group datefields">';
        foreach ($fields as $field => $options) {
            if ($options === '/') {
                ...
                $html .= '</span> <span class="availability-group datefields">';
                continue;
            }
            if ($options === ':') {
                $html .= ': ';
