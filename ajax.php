 ...
 *
 * @package availability_days - based on availability_date
 * @copyright 2018 Andrew Hancox
...
switch ($action) {
    case 'totime':
        ...
        echo \availability_days\frontend::get_time_from_fields(
    ...
    case 'fromtime' :
        ...
        echo json_encode(\availability_days\frontend::get_fields_from_time(
